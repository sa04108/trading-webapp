            ...
            if pending is not None and i>=due:
                ...
                for j in order:
                    ...
                    if not d['valid_open'][i,j]:
                        if p.invalid_open_policy!='range_worst':
                        ...
                        diagnostics.append({'date':today,'kind':'invalid_open_worst_bar_bound','symbol':str(self.symbols[j])})
