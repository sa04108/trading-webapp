 ...
 *
 * 쉼표 없는 순수 숫자(`9251406000000`)를 반드시 허용한다 — fnlttSinglAcntAll 의
 * 실제 금액 형식이다. 쉼표 묶음만 허용했던 검증이 실제 응답의 전 계정을 gap 으로
 * 버려 재무 팩트가 저장소에 거의 남지 않았다 (운영 장애 2026-08-10).
 * 쉼표를 쓰려면 세 자리 묶음이 완전해야 한다('12,34,567' 은 여전히 거부).
 */
