...
export function LoginPage() {
  ...
  const loginMutation = useMutation({
    mutationFn: (body: CredentialsForm) =>
      postJson<{ status: string }>("/auth/login", body),
  ...
  const totpMutation = useMutation({
    mutationFn: (body: TotpForm) =>
      postJson<{ status: string }>("/auth/totp/verify", body),
    onSuccess: async () => {
      setErrorMessage(null);
      await finishLogin();
    },
