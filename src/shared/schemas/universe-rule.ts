...
const rawUniverseStageSchema = z.discriminatedUnion("criterion", [
  z.object({
    criterion: z.literal("MARKET_CAP"),
    direction: universeDirectionSchema.optional(),
    limit: stageLimitSchema,
  }),
  z.object({
    criterion: z.literal("VOLUME"),
    direction: universeDirectionSchema.optional(),
    limit: stageLimitSchema,
  }),
  z.object({
    criterion: z.literal("TRADING_VALUE"),
    direction: universeDirectionSchema.optional(),
    limit: stageLimitSchema,
  }),
  z.object({
    criterion: z.literal("PER"),
    direction: universeDirectionSchema.optional(),
    limit: stageLimitSchema,
  }),
  z.object({
    criterion: z.literal("ROE"),
    direction: universeDirectionSchema.optional(),
    limit: stageLimitSchema,
  }),
  z.object({
...
export const universeStageSchema = rawUniverseStageSchema.transform(
  (stage) => ({
    ...stage,
...
export const universeRuleSchema = z
  .object({
