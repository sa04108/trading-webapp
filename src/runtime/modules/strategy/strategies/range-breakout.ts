...
} from "./shared/position-sizing.js";
import {
  confirmEntry,
  holdLimitReached,
  newHolding,
...
export const rangeBreakoutStrategy: TradingStrategy<
...
> = {
  ...
  dataRequirements: {
    priceWarmupBars: (parameters) =>
      Math.max(parameters.lookbackBars, parameters.atrPeriod),
  ...
  onBars(
    ...
    for (const [symbol, bar] of sortedBars) {
      ...
      const takeProfit =
        ...
        symbolState.holding.entryAtr !== null
          ? position.avgEntryPrice +
